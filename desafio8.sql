...
FROM w3schools.customers AS consumidores
INNER JOIN w3schools.orders AS pedidos
ON pedidos.ShipperID IN (1, 2)
WHERE consumidores.CustomerID = pedidos.CustomerID
