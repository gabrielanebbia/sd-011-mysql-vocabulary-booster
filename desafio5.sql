...
-- A segunda deve possuir o alias "Variação Salarial" e exibir a diferença entre os 
-- salários máximo e mínimo daquele cargo.
...
-- Em caso de empate na variação, os resultados devem ser ordenados pelo nome do 
