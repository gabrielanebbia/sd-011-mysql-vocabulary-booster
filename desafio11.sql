-- 11 - Exibe todas as pessoas clientes que possuem compatriotas, mostrando a quantidade
--  de compatriotas para cada pessoa cliente
...
A.Country as País,
(SELECT COUNT(*) -1 FROM customers B WHERE A.Country = B.Country) AS `Número de compatriotas`
