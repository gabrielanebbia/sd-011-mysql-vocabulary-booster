...
emp1.SALARY AS 'Salário funcionário 1', emp1.PHONE_NUMBER AS 'Telefone funcionário 1',
CONCAT(emp2.FIRST_NAME, ' ', emp2.LAST_NAME) AS `Nome completo funcionário 2`,
emp2.SALARY AS 'Salário funcionário 2', emp2.PHONE_NUMBER AS 'Telefone funcionário 2'
